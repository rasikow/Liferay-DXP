...
import books.data.service.BooksService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link books.data.service.impl.BooksServiceImpl}.
 * </p>
 *
 * @author zubair
...
public abstract class BooksServiceBaseImpl extends BaseServiceImpl
	implements BooksService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link books.data.service.BooksServiceUtil} to access the books remote service.
	 */
	 ...
	 */
	public books.data.service.BooksLocalService getBooksLocalService() {
	...
	public void setBooksLocalService(
		books.data.service.BooksLocalService booksLocalService) {
	...
	public String getOSGiServiceIdentifier() {
		return BooksService.class.getName();
	}
	...
	@BeanReference(type = books.data.service.BooksLocalService.class)
	protected books.data.service.BooksLocalService booksLocalService;
	@BeanReference(type = BooksService.class)
